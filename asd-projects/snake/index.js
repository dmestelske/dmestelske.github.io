...
function hasHitWall() {
  ...
  */
if (snake.head.row === 20 || snake.head.row === 0) {
  return true;
}
else if (snake.head.column === 20 || snake.head.column === 0 ) {
  return true;
}
  return false;
}
...
var column = snake.tail.column;
  ...
  if (snake.tail.direction === "left") {
    ...
    snake.tail.row = snake.head.row + 1;
  }
...
if (snake.head.row === snake.body[i+1].row && snake.head.column === snake.body[i].column ) {
  return true;
}
 }
  return false;
